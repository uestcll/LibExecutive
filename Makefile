...
CLMsgLoopManagerForLibevent.o : ./src/CLMsgLoopManagerForLibevent.cpp
	g++ -o CLMsgLoopManagerForLibevent.o -c ./src/CLMsgLoopManagerForLibevent.cpp -I./include -g
