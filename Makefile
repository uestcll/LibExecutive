...
CLMsgPostResultsNotifier.o : ./src/CLMsgPostResultsNotifier.cpp
	g++ -o CLMsgPostResultsNotifier.o -c ./src/CLMsgPostResultsNotifier.cpp -I./include -g
