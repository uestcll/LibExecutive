...
CLMsgLoopManagerForIOMultiplexing.o : ./src/CLMsgLoopManagerForIOMultiplexing.cpp
	g++ -o CLMsgLoopManagerForIOMultiplexing.o -c ./src/CLMsgLoopManagerForIOMultiplexing.cpp -I./include -g
...
CLMsgReceiverReleaser.o : ./src/CLMsgReceiverReleaser.cpp
	g++ -o CLMsgReceiverReleaser.o -c ./src/CLMsgReceiverReleaser.cpp -I./include -g

CLMsgReceiverReleaserForPrivatePipe.o : ./src/CLMsgReceiverReleaserForPrivatePipe.cpp
	g++ -o CLMsgReceiverReleaserForPrivatePipe.o -c ./src/CLMsgReceiverReleaserForPrivatePipe.cpp -I./include -g
