...
int main(int argc, char** agrv)
{
	...
	std::cout<<"(g_for_msg1 is , 2) "<< g_for_msg1<<std::endl;
	std::cout<<"(g_for_msg2 is , 2) "<< g_for_msg2<<std::endl;
	std::cout<<"(g_for_msg1_dese is , 1) "<< g_for_msg1_dese<<std::endl;
	std::cout<<"(g_for_msg2_dese is , 1) "<< g_for_msg2_dese<<std::endl;
	std::cout<<"(g_for_msg1_se is , 1) "<< g_for_msg1_se<<std::endl;
	std::cout<<"(g_for_msg2_se is , 1) "<< g_for_msg2_se<<std::endl;
